...
cam_width = 640                         # Resolution of camera (width)
cam_height = 480                        # Resolution of camera (height)
res_width = 320                         # Resolution of image (width)
res_height = 320                        # Resolution of image (height)
